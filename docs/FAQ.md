...
### "Do I have to load all 240 tools?"

No. Pare has 28 servers with ~9 tools each. You only install the servers you need — if you just want git, that's 24 tool definitions. We're also exploring more granular per-tool filtering — see [#111](https://github.com/Dave-London/Pare/issues/111).
