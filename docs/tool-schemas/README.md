...
| Server                | npm                   | Tools                                                                                                                                                                                                                                                      |
| --------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [git](git/)           | `@paretools/git`      | status, log, diff, branch, show, add, commit, push, pull, checkout, tag, stash-list, stash, remote, blame, log-graph, reflog, bisect, worktree                                                                                                             |
...
| [search](search/)     | `@paretools/search`   | search, find, count                                                                                                                                                                                                                                        |
...
| [cargo](cargo/)       | `@paretools/cargo`    | build, test, clippy, run, add, remove, fmt, doc, check, update, tree                                                                                                                                                                                       |
| [go](go/)             | `@paretools/go`       | build, test, vet, run, mod-tidy, fmt, generate, env, list, get                                                                                                                                                                                             |
