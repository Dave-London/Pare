  ...
  server.registerTool(
    "biome-check",
    {
      ...
      inputSchema: {
        ...
        apply: z.coerce.boolean().optional().describe("Apply safe fixes automatically (maps to --apply)"),
        applyUnsafe: z
          .boolean()
          .optional()
        ...
        staged: z.coerce.boolean().optional().describe("Only check staged files (maps to --staged)"),
        since: z
          .string()
