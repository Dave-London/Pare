  ...
  server.registerTool(
    "pull",
    {
      ...
      inputSchema: {
        ...
        autostash: z.coerce.boolean().optional().describe("Stash/unstash around pull (--autostash)"),
        noCommit: z.coerce.boolean().optional().describe("Pull without auto-committing (--no-commit)"),
