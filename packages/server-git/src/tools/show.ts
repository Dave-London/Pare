  ...
  server.registerTool(
    "show",
    {
      ...
      inputSchema: {
        ...
        patch: z.coerce.boolean().optional().describe("Include patch content in output (-p/--patch)"),
        ignoreWhitespace: z.coerce.boolean().optional().describe("Filter whitespace-only changes (-w)"),
